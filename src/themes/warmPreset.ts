...
export const warmChrome = {
  navRow1:
    'h-10 px-3 bg-gradient-to-r from-orange-200/90 via-amber-100 to-rose-200/70 text-sidebar-foreground hidden sm:flex items-center justify-between border-b border-orange-300/70 shadow-md shadow-orange-200/50',
  navRow1Mobile:
    'h-14 px-4 flex sm:hidden items-center justify-between bg-gradient-to-r from-orange-200/90 via-amber-100 to-rose-200/70 text-sidebar-foreground border-b border-orange-300/70 shadow-md shadow-orange-200/50',
  ...
  navTabsRow:
    'h-10 px-2 bg-gradient-to-r from-orange-100 via-amber-50 to-rose-100/80 hidden sm:flex items-end justify-between gap-2 border-b border-orange-200/70 overflow-x-auto',
  navTabActive:
  ...
  toolbarRow:
    'h-10 px-3 bg-gradient-to-r from-orange-50/90 via-amber-50/60 to-rose-50/50 hidden sm:flex items-center gap-1.5 border-b border-orange-100 overflow-x-auto',
  dashboardSurface:
