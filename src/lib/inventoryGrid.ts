  ...
  for (const rows of grids) {
    ...
    for (const p of rows) {
      ...
      bySku.set(key, {
        ...
        onHandStock: (Number(prev.onHandStock) || 0) + (Number(p.onHandStock) || 0),
        reservedStock: (Number(prev.reservedStock) || 0) + (Number(p.reservedStock) || 0),
        lockedStock: (Number(prev.lockedStock) || 0) + (Number(p.lockedStock) || 0),
        quotedStock: (Number(prev.quotedStock) || 0) + (Number(p.quotedStock) || 0),
