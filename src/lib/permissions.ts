...
export const PERMISSIONS: Permission[] = [
  ...
  { id: 'backdate_post', name: 'Backdate Posting', description: 'Post with a date before today (admin, or granted per user)', category: 'accounting' },
  { id: 'edit_historical', name: 'Edit Historical', description: 'Edit records dated before today (admin, or granted per user)', category: 'accounting' },
...
export const DEFAULT_ROLE_PERMISSIONS: RolePermissions[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'accounting_view', 'accounting_create', 'accounting_journal',
      'accounting_payment', 'accounting_receipt',
      'caixa_open', 'caixa_close', 'bank_manage', 'expense_create', 'expense_approve', 'client_manage',
