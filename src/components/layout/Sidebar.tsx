...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const navItems = [
    ...
    { icon: ShoppingBag, label: t.nav.salesOrders, path: '/sales-orders' },
    ...
    { icon: ArrowDownCircle, label: t.nav.receivables, path: '/receivables' },
    { icon: ArrowUpCircle, label: t.nav.payables, path: '/payables' },
