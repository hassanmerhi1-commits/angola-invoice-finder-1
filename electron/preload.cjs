...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  clientLocal: {
    ...
    listProductsCache: (branchId) => ipcRenderer.invoke('clientLocal:listProductsCache', branchId),
    syncClients: (clients) => ipcRenderer.invoke('clientLocal:syncClients', clients),
    listClientsCache: () => ipcRenderer.invoke('clientLocal:listClientsCache'),
    setWarmBranch: (branchId) => ipcRenderer.invoke('clientLocal:setWarmBranch', branchId),
